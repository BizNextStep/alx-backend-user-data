...
This module handles session authentication methods, providing functionality
to create, retrieve, and destroy user sessions.
"""
...
class SessionAuth(Auth):
    """Implement Session Authentication protocol methods."""
